...
void __init setup_pci_atmu(struct pci_controller *hose, struct resource *rsrc, int is_primary)
{
	...
	if (hose->io_resource.flags & IORESOURCE_IO) {
		pr_debug
		    ("PCI IO resource start 0x%08x, size 0x%08x, phy base 0x%08x.\n",
...
int __init fsl_add_bridge(struct device_node *dev, int is_primary)
{
	...
	setup_pci_atmu(hose, &rsrc, is_primary);
...
DECLARE_PCI_FIXUP_EARLY(0x1957, PCI_DEVICE_ID_MPC8543E,
			quirk_fsl_pcie_transparent);
DECLARE_PCI_FIXUP_EARLY(0x1957, PCI_DEVICE_ID_MPC8543,
			quirk_fsl_pcie_transparent);
DECLARE_PCI_FIXUP_EARLY(0x1957, PCI_DEVICE_ID_MPC8547E,
			quirk_fsl_pcie_transparent);
DECLARE_PCI_FIXUP_EARLY(0x1957, PCI_DEVICE_ID_MPC8545E,
			quirk_fsl_pcie_transparent);
DECLARE_PCI_FIXUP_EARLY(0x1957, PCI_DEVICE_ID_MPC8545,
			quirk_fsl_pcie_transparent);
DECLARE_PCI_FIXUP_EARLY(0x1957, PCI_DEVICE_ID_MPC8568E,
			quirk_fsl_pcie_transparent);
