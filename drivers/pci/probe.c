 ...
 * PCI Bus Class
 */
void release_pcibus_dev(struct class_device *class_dev)
{
 ...
 */
inline unsigned int pci_calc_resource_flags(unsigned int flags)
{
...
void pci_release_bus_bridge_dev(struct device *dev)
{
	kfree(dev);
}
